    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goal_status', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='usmanajibolaabassscrumy.GoalStatus')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_of_action', models.DateTimeField(verbose_name='Time of Action')),
                ('goal', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='usmanajibolaabassscrumy.ScrumyGoals')),
            ],
        ),
    ]
